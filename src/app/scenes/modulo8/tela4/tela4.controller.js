(function() {
  ...
  angular
    ...
    .controller('Modulo8_Tela4Controller', Modulo8_Tela4Controller);

  /** @ngInject */
  function Modulo8_Tela4Controller($log, $timeout, Game) {
    var vm = this;
    ...
    if(!Game.data.outros.modulo8.tela4){
      Game.data.outros.modulo8.tela4 = {
        finished: false,
        selected: -1,
        points: 0,
        try:0
    ...
    vm.quiz = Game.data.outros.modulo8.tela4;
    vm.feedback = false;
  ...
  Modulo8_Tela4Controller.$inject = ['$log', '$timeout', 'Game'];
})();
