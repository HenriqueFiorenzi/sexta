(function() {
  ...
  angular
    ...
    .controller('Modulo8_Tela7Controller', Modulo8_Tela7Controller);

  /** @ngInject */
  function Modulo8_Tela7Controller($log, $timeout, Game) {
    var vm = this;
    ...
    if(!Game.data.outros.modulo8.tela7){
      Game.data.outros.modulo8.tela7 = {
        finished: false,
        selected: -1,
        points: 0,
        try:0
    ...
    vm.quiz = Game.data.outros.modulo8.tela7;
    vm.feedback = false;
  ...
  Modulo8_Tela7Controller.$inject = ['$log', '$timeout', 'Game'];
})();
