(function() {
  ...
  angular
    ...
    .controller('Modulo8_Tela3Controller', Modulo8_Tela3Controller);

  /** @ngInject */
  function Modulo8_Tela3Controller($log, $timeout, Game, toastr) {
    var vm = this;
    ...
    if(!Game.data.outros.modulo8.tela3){
      Game.data.outros.modulo8.tela3 = {
        finished: false,
        selected: -1,
        points: 0,
        try:0
    ...
    vm.quiz = Game.data.outros.modulo8.tela3;
    vm.feedback = false;
  ...
  Modulo8_Tela3Controller.$inject = ['$log', '$timeout', 'Game', 'toastr'];
})();
