(function() {
  ...
  angular
    ...
    .controller('Modulo8_Tela6Controller', Modulo8_Tela6Controller);

  /** @ngInject */
  function Modulo8_Tela6Controller($log, $timeout, Game) {
    var vm = this;
    ...
    if(!Game.data.outros.modulo8.tela6){
      Game.data.outros.modulo8.tela6 = {
        finished: false,
        selected: -1,
        points: 0,
        try:0
    ...
    vm.quiz = Game.data.outros.modulo8.tela6;
    vm.feedback = false;
  ...
  Modulo8_Tela6Controller.$inject = ['$log', '$timeout', 'Game'];
})();
