(function() {
  ...
  angular
    ...
    .controller('Modulo8_Tela5Controller', Modulo8_Tela5Controller);

  /** @ngInject */
  function Modulo8_Tela5Controller($log, $timeout, Game) {
    var vm = this;
    ...
    if(!Game.data.outros.modulo8.tela5){
      Game.data.outros.modulo8.tela5 = {
        finished: false,
        selected: -1,
        points: 0,
        try:0
    ...
    vm.quiz = Game.data.outros.modulo8.tela5;
    vm.feedback = false;
  ...
  Modulo8_Tela5Controller.$inject = ['$log', '$timeout', 'Game'];
})();
