(function() {
  ...
  angular
    ...
    .controller('Modulo7_Tela1Controller', Modulo7_Tela1Controller);

  /** @ngInject */
  function Modulo7_Tela1Controller($log, $timeout, Game) {
    var vm = this;
    ...
    if(!Game.data.outros.modulo7.currentItem){
      Game.data.outros.modulo7 = {
        currentItem: -1,
        items: [false, false, false, false, false]
      }
    }

    vm.currentItem = Game.data.outros.modulo7.currentItem || -1;
    vm.items = Game.data.outros.modulo7.items || [false, false, false, false, false];
    vm.preScreen = vm.currentItem === -1 ? true : false;
    ...
    vm.selectMenu = function(id){
      ...
      $timeout(function(){
        ...
        vm.currentSelected['tela' + (id + 1)] = 0
    ...
    vm.select = function(tela, id, callback, sequencial, evt){
      $timeout(function(){
        ...
        /*console.log(Game.data.outros.modulo7['sub' + tela], id)
        if(Game.data.outros.modulo7['sub' + tela]){
          if(!Game.data.outros.modulo7['sub' + tela][id]){
    ...
    if(!Game.data.outros.modulo7.tela1){
      Game.data.outros.modulo7.tela1 = [true, false, false, false, false];
    }

    vm.completeds.tela1 = Game.data.outros.modulo7.tela1;
    vm.currentSelected.tela1 = 0;
    ...
    if(!Game.data.outros.modulo7.tela2){
      Game.data.outros.modulo7.tela2 = [true, false, false, false, false];
    }

    vm.completeds.tela2 = Game.data.outros.modulo7.tela2;
    ...
    if(!Game.data.outros.modulo7.tela3){
      Game.data.outros.modulo7.tela3 = [true, false, false, false, false, false, false, false, false, false];
    }

    vm.completeds.tela3 = Game.data.outros.modulo7.tela3;
    ...
    if(!Game.data.outros.modulo7.tela4){
      Game.data.outros.modulo7.tela4 = [true, false, false];
    }

    vm.completeds.tela4 = Game.data.outros.modulo7.tela4;
    ...
    if(!Game.data.outros.modulo7.tela5){
      Game.data.outros.modulo7.tela5 = [true, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false];
    }

    vm.completeds.tela5 = Game.data.outros.modulo7.tela5;
  ...
  Modulo7_Tela1Controller.$inject = ['$log', '$timeout', 'Game'];
})();
